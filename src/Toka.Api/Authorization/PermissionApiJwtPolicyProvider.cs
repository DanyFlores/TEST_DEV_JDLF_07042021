...
{
    public class PermissionApiJwtPolicyProvider : IAuthorizationPolicyProvider
    {
        const string POLICY_PREFIX = "Permission";
        public DefaultAuthorizationPolicyProvider FallbackPolicyProvider { get; }
        public PermissionApiJwtPolicyProvider(IOptions<AuthorizationOptions> options)
        {
        ...
        public Task<AuthorizationPolicy> GetPolicyAsync(string policyName)
        {
                ...
                int.TryParse(policyName.Substring(POLICY_PREFIX.Length), out var permission))
            {
                ...
                policy.AddRequirements(new PermissionApiJwtRequirement(permission));
